...
class AppColor{
  ...
  static Color homePageContainerTextSmallse=const Color(0xFFf4f5fd);
  ...
  static Color secondPageContainerGradient1stColor=Color.fromARGB(255, 38, 72, 208);
   static Color secondPageContainerGradient2ndColor=Color.fromARGB(255, 118, 145, 243);
